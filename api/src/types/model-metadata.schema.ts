...
export function asModelUid(uid: string): ModelUid {
  return uid as ModelUid;
}
export function asEquivalenceGroupId(id: string): EquivalenceGroupId {
  return id as EquivalenceGroupId;
}
