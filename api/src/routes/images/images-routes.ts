...
export async function registerImagesRoutes(server: FastifyInstance): Promise<void> {
  ...
  server.post('/v1/images/generations', {
      ...
      body: {
        ...
        properties: {
          model: {
            ...
            default: 'auto',
            description:
              'Model ID or "auto" for intelligent selection. When "auto", Ailin orchestrates across 500+ models to find the best image generation model.',
          },
          prompt: {
            type: 'string',
            minLength: 1,
              ...
              items: {
                ...
                properties: {
                  url: {
                    type: 'string',
                    format: 'uri',
                    description: 'URL of generated image (when response_format=url)',
                  },
                  b64_json: {
                    type: 'string',
            ...
            error: {
              ...
              properties: {
                ...
                code: {
                  type: 'string',
                  description:
                    'Error code (e.g., "invalid_prompt", "invalid_parameter", "invalid_size")',
                },
              },
            },
          },
    ...
    handler: async (
      ...
      log.info(
        { requestId, model, promptLength: prompt.length, n, size, quality },
      ...
      body: {
        ...
        properties: {
          ...
          model: {
            ...
            default: 'auto',
            description:
              'Model ID or "auto" for intelligent selection. When "auto", Ailin orchestrates across 500+ models to find the best image editing model.',
          },
          n: {
            type: 'integer',
            minimum: 1,
          ...
          response_format: {
            ...
            default: 'url',
            description:
              'Format of the response images: "url" returns publicly accessible URLs, "b64_json" returns base64-encoded images in JSON format.',
          },
          strategy: {
            type: 'string',
            enum: [
              ...
              items: {
                ...
                properties: {
                  url: {
                    ...
                    nullable: true,
                    description:
                      'Publicly accessible URL of the edited image (when response_format is "url")',
                  },
                  b64_json: {
                    type: 'string',
                    nullable: true,
          ...
          properties: {
            error: {
              ...
              properties: {
                ...
                code: {
                  type: 'string',
                  description: 'Error code (e.g., "invalid_image_format", "invalid_parameter")',
                },
              },
            },
          },
      ...
      try {
        ...
        const prompt =
          ...
          typeof fields.prompt.value === 'string'
            ...
            : undefined;
        const n =
          typeof fields.n === 'object' &&
          fields.n !== null &&
          'value' in fields.n &&
          typeof fields.n.value === 'string'
            ? parseInt(fields.n.value, 10)
            : 1;
        const size =
          typeof fields.size === 'object' &&
          fields.size !== null &&
          'value' in fields.size &&
        ...
        log.info(
          { requestId, model, promptLength: prompt.length, hasMask: !!maskBuffer },
          'Image edit processing started'
        );
      ...
      response: {
        200: {
          ...
          properties: {
            created: {
              type: 'integer',
              description: 'Unix timestamp when the variations were created',
            },
            data: {
              type: 'array',
          ...
          properties: {
            error: {
              ...
              properties: {
                ...
                code: {
                  type: 'string',
                  description: 'Error code (e.g., "invalid_parameter", "invalid_image_format")',
                },
              },
            },
          },
